...
vim.keymap.set("n", "<leader>gpr", "<Cmd>w<CR><Cmd>!g++ -o main % -Wall -Wextra -g3 -std=c++20 -fsanitize=signed-integer-overflow -fsanitize=address<CR><Cmd>!./main<CR>", { noremap = true })
